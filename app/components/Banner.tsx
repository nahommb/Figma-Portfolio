...
export default function Banner(): React.JSX.Element {
  const texts = ["Software Engineer", "Fullstack Developer", "Flutter Developer", ];
      ...
      <div className="container mx-auto max-w-6xl">
                ...
                <div className="relative inline-block ">
                  ...
                  <div className="relative">
                    <p className="text-white text-lg whitespace-nowrap">
                      Hello! I Am{" "}
                      <span className="text-purple-400">Nahom Melese</span>
                    </p>
                  </div>
        ...
        <div className="space-y-3 pt-15 text-center lg:text-left">
          ...
          <p className="text-lg lg:text-xl text-white/90 tracking-wide flex flex-wrap items-center justify-center lg:justify-start gap-2">
            <span>Currently, I&apos;m a Fullstack Developer at</span>
            <span className="flex items-center gap-2">
              <Image src="/assets/webhr.webp" alt="WebHR" width={20} height={20} className="w-5 h-5" style={{ width: "auto", height: "auto" }} />
              <span className="text-blue-400 font-semibold"> <a href="https://ethiosolutionplc.com/" target="_blank" rel="noopener noreferrer" className="hover:underline">
                Ethio Solutions,
              </a></span>
            </span>
          </p>
          <p className="text-lg text-white/80 max-w-2xl mt-15 mx-auto lg:mx-0">
            Skilled Full-Stack Developer with expertise in the MERN stack (MongoDB, Express, React, Node.js)
            and cross-platform mobile app development 
            using Flutter. Proficient in building dynamic user experiences
            and reliable backend systems, with a strong commitment to code quality and project efficiency.
          </p>
